...
const julia_types = DataType[Bool,
    Int8,
    UInt8,
    Int16,
    UInt16,
...
const inlined_funcs = [
    ...
    "UA_X509IdentityToken_init",
    "UA_X509IdentityToken_new",
    "UA_X509IdentityToken_copy",
    ...
    "UA_HistoryReadValueId_init",
    "UA_HistoryReadValueId_new",
    "UA_HistoryReadValueId_copy",
    "UA_HistoryReadValueId_deleteMembers",
    "UA_HistoryReadValueId_clear",
    "UA_HistoryReadValueId_delete",
    "UA_HistoryReadResult_init",
    "UA_HistoryReadResult_new",
    "UA_HistoryReadResult_copy",
    "UA_HistoryReadResult_deleteMembers",
    "UA_HistoryReadResult_clear",
    "UA_HistoryReadResult_delete",
    "UA_ReadRawModifiedDetails_init",
    "UA_ReadRawModifiedDetails_new",
    "UA_ReadRawModifiedDetails_copy",
    "UA_ReadRawModifiedDetails_deleteMembers",
    "UA_ReadRawModifiedDetails_clear",
    "UA_ReadRawModifiedDetails_delete",
    "UA_ReadAtTimeDetails_init",
    "UA_ReadAtTimeDetails_new",
    "UA_ReadAtTimeDetails_copy",
    "UA_ReadAtTimeDetails_deleteMembers",
    "UA_ReadAtTimeDetails_clear",
    "UA_ReadAtTimeDetails_delete",
    "UA_HistoryData_init",
    "UA_HistoryData_new",
    "UA_HistoryData_copy",
    "UA_HistoryData_deleteMembers",
    "UA_HistoryData_clear",
    "UA_HistoryData_delete",
    "UA_HistoryReadRequest_init",
    "UA_HistoryReadRequest_new",
    "UA_HistoryReadRequest_copy",
    "UA_HistoryReadRequest_deleteMembers",
    "UA_HistoryReadRequest_clear",
    "UA_HistoryReadRequest_delete",
    "UA_HistoryReadResponse_init",
    "UA_HistoryReadResponse_new",
    "UA_HistoryReadResponse_copy",
    "UA_HistoryReadResponse_deleteMembers",
    ...
    "UA_HistoryUpdateType_init",
    "UA_HistoryUpdateType_new",
    "UA_HistoryUpdateType_copy",
    "UA_HistoryUpdateType_deleteMembers",
    "UA_HistoryUpdateType_clear",
    "UA_HistoryUpdateType_delete",
    "UA_PerformUpdateType_init",
    "UA_PerformUpdateType_new",
    "UA_PerformUpdateType_copy",
    "UA_PerformUpdateType_deleteMembers",
    "UA_PerformUpdateType_clear",
    "UA_PerformUpdateType_delete",
    "UA_UpdateDataDetails_init",
    "UA_UpdateDataDetails_new",
    "UA_UpdateDataDetails_copy",
    "UA_UpdateDataDetails_deleteMembers",
    "UA_UpdateDataDetails_clear",
    "UA_UpdateDataDetails_delete",
    ...
    "UA_HistoryUpdateResult_new",
    "UA_HistoryUpdateResult_copy",
    "UA_HistoryUpdateResult_deleteMembers",
    "UA_HistoryUpdateResult_clear",
    "UA_HistoryUpdateResult_delete",
    "UA_HistoryUpdateRequest_init",
    "UA_HistoryUpdateRequest_new",
    "UA_HistoryUpdateRequest_copy",
    "UA_HistoryUpdateRequest_deleteMembers",
    "UA_HistoryUpdateRequest_clear",
    "UA_HistoryUpdateRequest_delete",
    "UA_HistoryUpdateResponse_init",
    "UA_HistoryUpdateResponse_new",
    "UA_HistoryUpdateResponse_copy",
    "UA_HistoryUpdateResponse_deleteMembers",
    "UA_HistoryUpdateResponse_clear",
    "UA_HistoryUpdateResponse_delete",
    "UA_CallMethodRequest_init",
    ...
    "UA_EventFilterResult_init",
    "UA_EventFilterResult_new",
    "UA_EventFilterResult_copy",
    ...
    "UA_HistoryEventFieldList_new",
    "UA_HistoryEventFieldList_copy",
    "UA_HistoryEventFieldList_deleteMembers",
    ...
    "UA_RepublishResponse_init",
    "UA_RepublishResponse_new",
    "UA_RepublishResponse_copy",
    ...
    "UA_ComplexNumberType_init",
    "UA_ComplexNumberType_new",
    "UA_ComplexNumberType_copy",
    ...
    "UA_ReadEventDetails_init",
    "UA_ReadEventDetails_new",
    "UA_ReadEventDetails_copy",
    "UA_ReadEventDetails_deleteMembers",
    "UA_ReadEventDetails_clear",
    "UA_ReadEventDetails_delete",
    "UA_ReadProcessedDetails_init",
    "UA_ReadProcessedDetails_new",
    "UA_ReadProcessedDetails_copy",
    "UA_ReadProcessedDetails_deleteMembers",
    "UA_ReadProcessedDetails_clear",
    "UA_ReadProcessedDetails_delete",
    "UA_ModificationInfo_init",
    "UA_ModificationInfo_new",
    "UA_ModificationInfo_copy",
    "UA_ModificationInfo_deleteMembers",
    "UA_ModificationInfo_clear",
    "UA_ModificationInfo_delete",
    "UA_HistoryModifiedData_init",
    "UA_HistoryModifiedData_new",
    "UA_HistoryModifiedData_copy",
    "UA_HistoryModifiedData_deleteMembers",
    "UA_HistoryModifiedData_clear",
    "UA_HistoryModifiedData_delete",
    "UA_HistoryEvent_init",
    "UA_HistoryEvent_new",
    "UA_HistoryEvent_copy",
    "UA_HistoryEvent_deleteMembers",
    "UA_HistoryEvent_clear",
    "UA_HistoryEvent_delete",
...
const attributes_UA_Client_Service = Vector{String}[["UA_Client_Service_read", "read"],
    ...
    ["UA_Client_Service_call", "call"],
    ["UA_Client_Service_addNodes", "addNodes"],
    ["UA_Client_Service_addReferences", "addReferences"],
    ["UA_Client_Service_deleteNodes", "deleteNodes"],
    ["UA_Client_Service_deleteReferences", "deleteReferences"],
    ["UA_Client_Service_browse", "browse"],
    ["UA_Client_Service_browseNext", "browseNext"],
    ["UA_Client_Service_translateBrowsePathsToNodeIds", "translateBrowsePathsToNodeIds"],
    ["UA_Client_Service_registerNodes", "registerNodes"],
...
const attributes_UA_Client_read = Vector{String}[[
    ...
    ["UA_Client_readNodeClassAttribute", "NodeClass", "UA_NodeClass"],
    ["UA_Client_readBrowseNameAttribute", "BrowseName", "UA_QualifiedName"],
    ["UA_Client_readDisplayNameAttribute", "DisplayName", "UA_LocalizedText"],
    ["UA_Client_readDescriptionAttribute", "Description", "UA_LocalizedText"],
    ["UA_Client_readWriteMaskAttribute", "WriteMask", "UA_UInt32"],
    ["UA_Client_readUserWriteMaskAttribute", "UserWriteMask", "UA_UInt32"],
    ["UA_Client_readIsAbstractAttribute", "IsAbstract", "UA_Boolean"],
    ["UA_Client_readSymmetricAttribute", "Symmetric", "UA_Boolean"],
    ["UA_Client_readInverseNameAttribute", "InverseName", "UA_LocalizedText"],
    ["UA_Client_readContainsNoLoopsAttribute", "ContainsNoLoops", "UA_Boolean"],
    ["UA_Client_readEventNotifierAttribute", "EventNotifier", "UA_Byte"],
    ["UA_Client_readValueAttribute", "Value", "UA_Variant"],
    ["UA_Client_readDataTypeAttribute", "DataType", "UA_NodeId"],
    ["UA_Client_readValueRankAttribute", "ValueRank", "UA_Int32"],
    ["UA_Client_readAccessLevelAttribute", "AccessLevel", "UA_Byte"],
    ["UA_Client_readUserAccessLevelAttribute", "UserAccessLevel", "UA_Byte"],
    [
        "UA_Client_readMinimumSamplingIntervalAttribute",
...
const attributes_UA_Client_write = Vector{String}[[
    ...
    ["UA_Client_writeNodeClassAttribute", "NodeClass", "UA_NodeClass"],
    ["UA_Client_writeBrowseNameAttribute", "BrowseName", "UA_QualifiedName"],
    ["UA_Client_writeDisplayNameAttribute", "DisplayName", "UA_LocalizedText"],
    ["UA_Client_writeDescriptionAttribute", "Description", "UA_LocalizedText"],
    ["UA_Client_writeWriteMaskAttribute", "WriteMask", "UA_UInt32"],
    ["UA_Client_writeUserWriteMaskAttribute", "UserWriteMask", "UA_UInt32"],
    ["UA_Client_writeIsAbstractAttribute", "IsAbstract", "UA_Boolean"],
    ["UA_Client_writeSymmetricAttribute", "Symmetric", "UA_Boolean"],
    ["UA_Client_writeInverseNameAttribute", "InverseName", "UA_LocalizedText"],
    ["UA_Client_writeContainsNoLoopsAttribute", "ContainsNoLoops", "UA_Boolean"],
    ["UA_Client_writeEventNotifierAttribute", "EventNotifier", "UA_Byte"],
    ["UA_Client_writeValueAttribute", "Value", "UA_Variant"],
    ["UA_Client_writeDataTypeAttribute", "DataType", "UA_NodeId"],
    ["UA_Client_writeValueRankAttribute", "ValueRank", "UA_Int32"],
    ["UA_Client_writeAccessLevelAttribute", "AccessLevel", "UA_Byte"],
    ...
    ["UA_Client_writeHistorizingAttribute", "Historizing", "UA_Boolean"],
...
const attributes_UA_Client_write_async = Vector{String}[[
    ...
    ["UA_Client_writeNodeIdAttribute_async", "NodeId", "UA_NodeId"],
    ["UA_Client_writeNodeClassAttribute_async", "NodeClass", "UA_NodeClass"],
    ["UA_Client_writeBrowseNameAttribute_async", "BrowseName", "UA_QualifiedName"],
    ["UA_Client_writeDisplayNameAttribute_async", "DisplayName", "UA_LocalizedText"],
    ["UA_Client_writeDescriptionAttribute_async", "Description", "UA_LocalizedText"],
    ["UA_Client_writeWriteMaskAttribute_async", "WriteMask", "UA_UInt32"],
    ["UA_Client_writeUserWriteMaskAttribute_async", "UserWriteMask", "UA_UInt32"],
    ["UA_Client_writeIsAbstractAttribute_async", "IsAbstract", "UA_Boolean"],
    ["UA_Client_writeSymmetricAttribute_async", "Symmetric", "UA_Boolean"],
    ["UA_Client_writeInverseNameAttribute_async", "InverseName", "UA_LocalizedText"],
    ["UA_Client_writeContainsNoLoopsAttribute_async", "ContainsNoLoops", "UA_Boolean"],
    ["UA_Client_writeEventNotifierAttribute_async", "EventNotifier", "UA_Byte"],
    ["UA_Client_writeDataTypeAttribute_async", "DataType", "UA_NodeId"],
    ["UA_Client_writeValueRankAttribute_async", "ValueRank", "UA_Int32"],
    ["UA_Client_writeAccessLevelAttribute_async", "AccessLevel", "UA_Byte"],
    ["UA_Client_writeUserAccessLevelAttribute_async", "UserAccessLevel", "UA_Byte"],
...
const attributes_UA_Server_read = Vector{String}[[
    ...
    ["UA_Server_readNodeClass", "NodeClass", "UA_NodeClass"],
    ["UA_Server_readBrowseName", "BrowseName", "UA_QualifiedName"],
    ["UA_Server_readDisplayName", "DisplayName", "UA_LocalizedText"],
    ["UA_Server_readDescription", "Description", "UA_LocalizedText"],
    ["UA_Server_readWriteMask", "WriteMask", "UA_UInt32"],
    ["UA_Server_readIsAbstract", "IsAbstract", "UA_Boolean"],
    ["UA_Server_readSymmetric", "Symmetric", "UA_Boolean"],
    ["UA_Server_readInverseName", "InverseName", "UA_LocalizedText"],
    ["UA_Server_readContainsNoLoops", "ContainsNoLoops", "UA_Boolean"],
    ["UA_Server_readEventNotifier", "EventNotifier", "UA_Byte"],
    ["UA_Server_readValue", "Value", "UA_Variant"],
    ["UA_Server_readDataType", "DataType", "UA_NodeId"],
    ["UA_Server_readValueRank", "ValueRank", "UA_Int32"],
    ["UA_Server_readArrayDimensions", "ArrayDimensions", "UA_Variant"],
    ["UA_Server_readAccessLevel", "AccessLevel", "UA_Byte"],
...
const attributes_UA_Server_write = Vector{String}[[
    ...
    ["UA_Server_writeDisplayName", "DisplayName", "UA_LocalizedText"],
    ["UA_Server_writeDescription", "Description", "UA_LocalizedText"],
    ["UA_Server_writeWriteMask", "WriteMask", "UA_UInt32"],
    ["UA_Server_writeIsAbstract", "IsAbstract", "UA_Boolean"],
    ["UA_Server_writeInverseName", "InverseName", "UA_LocalizedText"],
    ["UA_Server_writeEventNotifier", "EventNotifier", "UA_Byte"],
    ["UA_Server_writeValue", "Value", "UA_Variant"],
    ["UA_Server_writeDataValue", "DataValue", "UA_DataValue"],
    ["UA_Server_writeDataType", "DataType", "UA_NodeId"],
    ["UA_Server_writeValueRank", "ValueRank", "UA_Int32"],
    ["UA_Server_writeArrayDimensions", "ArrayDimensions", "UA_Variant"],
    ["UA_Server_writeAccessLevel", "AccessLevel", "UA_Byte"],
    ["UA_Server_writeMinimumSamplingInterval", "MinimumSamplingInterval", "UA_Double"],
    ["UA_Server_writeHistorizing", "Historizing", "UA_Boolean"],
    ["UA_Server_writeExecutable", "Executable", "UA_Boolean"]]
