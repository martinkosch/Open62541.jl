...
function UA_ServerConfig_setMinimal(config::Union{Ref{UA_ServerConfig},Ptr{UA_ServerConfig}},
        portNumber::Integer,
...
function UA_ServerConfig_setDefault(config::Union{Ref{UA_ServerConfig},Ptr{UA_ServerConfig}})
